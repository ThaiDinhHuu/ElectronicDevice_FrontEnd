      ...
      return (
            <div>
                  ...
                  <div style={{ marginTop: '10px' }}>
                        <Button style={{ height: '150px', width: '150px', borderRadius: '6px', borderStyle: 'dashed' }} onClick={() => setOpen(true)} ><PlusOutlined style={{ fontSize: '60px' }} /></Button>
                  </div>
                  <div>
                        <TableComponent columns={columns} isLoadingProducts={isLoadingProducts} data={dataTable} onRow={(record, rowIndex) => {
                              return {
                                    onClick: event => {
                  ...
                  <ModalComponent forceRender open={open} title="Tạo sản phẩm" onCancel={handleCancel} footer={null}>
                  ...
                  <ModalComponent open={isModalOpenDelete} title="Xóa sản phẩm" onCancel={handleCancelDelete} onOk={handleDeleteProduct} >
